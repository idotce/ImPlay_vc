...
function(get_mpv_win_dev name)
  set(LOCAL_MPV_LIB "${CMAKE_SOURCE_DIR}/third_party/mpv.lib")
  ExternalProject_Add(${name}
    ...
    INSTALL_COMMAND ${CMAKE_COMMAND} -E copy_directory <SOURCE_DIR>/include <BINARY_DIR>/include
            ...
            COMMAND ${CMAKE_COMMAND} -E copy "${LOCAL_MPV_LIB}" <BINARY_DIR>
            COMMAND ${CMAKE_COMMAND} -E copy "${LOCAL_MPV_LIB}" ${CMAKE_BINARY_DIR}
    )
